...
def p_mientras_instr(t) :
    'mientrastanto_instr     : MIENTRAS PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] =Mientras(t[3], t[6])

def p_if_instr(t) :
    'si_instr           : IF PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] =If(t[3], t[6])

def p_if_else_instr(t) :
    'si_no_instr      : IF PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER ELSE LLAVIZQ instrucciones LLAVDER'
    t[0] =IfElse(t[3], t[6], t[10])

def p_para_instr(t):
    'para_instr : PARA NUMERO IGUAL ENTERO HASTA ENTERO LLAVIZQ instrucciones LLAVDER'
    t[0] = Para(t[2], t[4], t[6], t[8], t[11])
